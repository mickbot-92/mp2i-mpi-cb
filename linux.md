...
Enfin, sur Windows, WSL peut être utilisé. Voir [la documentation de VS Code](https://code.visualstudio.com/docs/cpp/config-wsl) (non testée de mon côté).
## Installation avec Msys2/CygWin
Sur Windows toujours, il y a [cela de possible](https://code.visualstudio.com/docs/cpp/config-mingw), sans avoir besoin d'être admin. Néanmoins je ne vous le recommande pas spécialement, car sur le terminal de VSCodium vous ne verrez pas les erreurs au lancement de votre programme codé en C, par expérience.
## Utilisez [VSCodium](https://vscodium.com) plutôt que VS Code !!
En plus du caractère open-source de VSCodium, il reprend les fonctionnalités de VS Code, avec la télémétrie et l'auto-complétion de retirée.
